        ...
        const fetchEvents = () => {
            ...
            if (storedUser) {
                try {
                    ...
                    const eventsKey = `events_${userData.id || userData._id || 'default'}`;
                    const storedEvents = JSON.parse(localStorage.getItem(eventsKey) || localStorage.getItem(`events_${userData.id}`) || "[]");
                    
                    const formattedEvents = storedEvents.map((evt: any, index: number) => {
                        ...
                        return {
                            id: String(index + 1),
                            ngoName: evt.ngoName || "Unknown NGO",
                            eventDate: dateStr,
                    ...
                    console.error("Error formatting user events", err);
                }
            }
        };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
                ...
                <section>
                    ...
                    {userEvents.length > 0 ? (
                        ...
                        <div className="text-center text-muted-foreground p-8 bg-card rounded-xl border">
