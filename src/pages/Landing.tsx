    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">What We Do</h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            HopeConnect is a bridge between compassionate donors and organizations making real change. 
            We make giving simple, transparent, and impactful by connecting you directly with verified NGOs 
            and showing you exactly where your contributions go.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <Card className="card-hover">
              <CardContent className="p-8">
                ...
                <h3 className="text-2xl font-bold mb-4 text-foreground">✅ For Donors</h3>
            ...
            <Card className="card-hover">
              <CardContent className="p-8">
                <div className="text-4xl mb-4">🏢</div>
                <h3 className="text-2xl font-bold mb-4 text-foreground">✅ For NGOs / Organizations</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-center space-x-2">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-foreground">Our Impact So Far</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <StatCard icon="👥" value="5200+" label="Users" delay={0} />
            <StatCard icon="🏢" value="120+" label="NGOs Registered" delay={200} />
            <StatCard icon="💰" value="25000000" label="Donated" delay={400} />
            <StatCard icon="🍲" value="45000+" label="Meals Served" delay={600} />
          </div>
        </div>
      </section>
