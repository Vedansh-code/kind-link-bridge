#UREGENCY AND PRIORITY PREDICTION 
...
# Parameters
num_children = 2000
folder_path = r"C:\Users\kanis\OneDrive\Desktop\KANISHKA\PROJECT\orphnage\data\dataset3"
...
for i in range(1, num_children+1):
    ...
    rows.append([child_id, need_type, request_date_str, amount_required,percent_funded, num_sponsors, last_updated_days, criticality_label])
